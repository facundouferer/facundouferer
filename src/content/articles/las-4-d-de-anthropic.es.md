...
![Las 4 D de Anthropic: el marco de fluidez en IA](/img/articles/las-4-d-de-anthropic.svg)
...
<svg viewBox="0 0 900 340" xmlns="http://www.w3.org/2000/svg" width="820">
  <defs>
    <marker id="arrowScaleEs" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse">
  ...
  <text x="135" y="48" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="13" font-weight="700" fill="#2d4a6b">🏛️ Arquitectura</text>
  ...
  <text x="450" y="48" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="13" font-weight="700" fill="#2d4a6b">📚 Datos</text>
  <text x="450" y="66" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="12" fill="#2d4a6b">explosión de texto digital</text>
  <rect x="650" y="20" width="230" height="70" rx="10" fill="#eef3fa" stroke="#5b7fa6" stroke-width="1.5"/>
  <text x="765" y="48" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="13" font-weight="700" fill="#2d4a6b">⚡ Cómputo</text>
  ...
  <path d="M135,90 L135,150 L370,150" fill="none" stroke="#333333" stroke-width="2" marker-end="url(#arrowScaleEs)"/>
  <path d="M450,90 L450,150" fill="none" stroke="#333333" stroke-width="2" marker-end="url(#arrowScaleEs)"/>
  <path d="M765,90 L765,150 L530,150" fill="none" stroke="#333333" stroke-width="2" marker-end="url(#arrowScaleEs)"/>
  <rect x="300" y="150" width="300" height="80" rx="10" fill="#3f6690"/>
  <text x="450" y="180" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="13" font-weight="700" fill="#ffffff">Leyes de escala:</text>
  <text x="450" y="200" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="12" fill="#e8eef5">más tamaño + datos + cómputo</text>
  <text x="450" y="218" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="12" fill="#e8eef5">= mejora predecible</text>
  <line x1="450" y1="230" x2="450" y2="255" stroke="#333333" stroke-width="2" marker-end="url(#arrowScaleEs)"/>
  <rect x="270" y="255" width="360" height="75" rx="10" fill="#4d8a5c"/>
  <text x="450" y="282" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="13" font-weight="700" fill="#ffffff">✨ Capacidades emergentes</text>
  <text x="450" y="300" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="12" fill="#eaf3ec">razonar paso a paso,</text>
  <text x="450" y="317" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="12" fill="#eaf3ec">adaptarse con instrucciones mínimas</text>
</svg>
...
- **Fecha de corte del conocimiento.** El modelo no sabe nada de lo que pasó después de su fecha de entrenamiento. Necesita herramientas como búsqueda web para enterarse de novedades.
...
<svg viewBox="0 0 900 280" xmlns="http://www.w3.org/2000/svg" width="820">
  <defs>
    <marker id="arrowLoopEs" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse">
      <path d="M0,0 L10,5 L0,10 z" fill="#333333"/>
    </marker>
  </defs>
  <rect x="0" y="0" width="900" height="280" rx="12" fill="#ffffff"/>
  <path d="M780,110 C780,40 120,40 120,110" fill="none" stroke="#999999" stroke-width="2" stroke-dasharray="5 4" marker-end="url(#arrowLoopEs)"/>
  <rect x="20" y="110" width="170" height="70" rx="10" fill="#eef3fa" stroke="#5b7fa6" stroke-width="1.5"/>
  <text x="105" y="150" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="14" font-weight="700" fill="#2d4a6b">✍️ Describís</text>
  <line x1="190" y1="145" x2="230" y2="145" stroke="#333333" stroke-width="2" marker-end="url(#arrowLoopEs)"/>
  <rect x="235" y="110" width="170" height="70" rx="10" fill="#eef3fa" stroke="#5b7fa6" stroke-width="1.5"/>
  <text x="320" y="140" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="14" font-weight="700" fill="#2d4a6b">🤖 La IA</text>
  <text x="320" y="158" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="12" fill="#2d4a6b">responde</text>
  <line x1="405" y1="145" x2="445" y2="145" stroke="#333333" stroke-width="2" marker-end="url(#arrowLoopEs)"/>
  <rect x="450" y="110" width="180" height="70" rx="10" fill="#eef3fa" stroke="#5b7fa6" stroke-width="1.5"/>
  <text x="540" y="140" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="14" font-weight="700" fill="#2d4a6b">🔍 Evaluás</text>
  <text x="540" y="158" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="12" fill="#2d4a6b">(discernimiento)</text>
  <line x1="630" y1="145" x2="670" y2="145" stroke="#333333" stroke-width="2" marker-end="url(#arrowLoopEs)"/>
  <rect x="675" y="110" width="180" height="70" rx="10" fill="#eef3fa" stroke="#5b7fa6" stroke-width="1.5"/>
  <text x="765" y="140" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="14" font-weight="700" fill="#2d4a6b">🔧 Ajustás la</text>
  <text x="765" y="158" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="12" fill="#2d4a6b">descripción</text>
  <path d="M540,180 L540,225 L500,225" fill="none" stroke="#333333" stroke-width="2" marker-end="url(#arrowLoopEs)"/>
  <text x="640" y="205" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="11" font-style="italic" fill="#666666">cuando el resultado está a la altura</text>
  <rect x="330" y="205" width="150" height="45" rx="22" fill="#4d8a5c"/>
  <text x="405" y="233" text-anchor="middle" font-family="Arial, Helvetica, sans-serif" font-size="13" font-weight="700" fill="#ffffff">✅ Listo</text>
</svg>
...
Describir no es "prompt engineering". Es una competencia de más alto nivel, que sigue siendo relevante aunque cambien los trucos de cada modelo puntual. Se puede pensar como una cadena de cuatro pasos, donde el constructor actúa como traductor:
...
Un producto que funciona y un buen producto no son lo mismo. Cuando la IA puede producir algo funcional en minutos, distinguir esa diferencia se vuelve la habilidad más valiosa. Hay cinco lentes — la mayoría de la formación en ingeniería se queda en las primeras dos:
...
**Fuentes:** Anthropic (Anthropic Academy) — *"What is generative AI"*, *"The 4D Framework for AI Fluency"*, *"Delegation & the builder's toolkit"*, *"Describing what users need"*, *"Discernment for code"*, *"Diligence & sharing your work"* y *"Looking forward"*.
