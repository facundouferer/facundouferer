**Archify: cuando el agente de IA también tiene que explicar la arquitectura**
...
Hay una decisión de diseño interesante: **Archify no quiere auto-layout genérico**. Sus autores probaron ese camino con Mermaid y concluyeron que eliminaba precisamente aquello que hacía atractivos los resultados. El agente decide jerarquía, posición y énfasis; Archify controla consistencia y validación. Tampoco pretende convertirse en un editor WYSIWYG. Es una herramienta para agentes, no otro [Draw.io](http://Draw.io) con esteroides generativos.
